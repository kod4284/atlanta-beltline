...
public class EmployeeVisitor extends Employee {
    ...
    public EmployeeVisitor(String username, String firstName, String
            lastName, String password, String userType, ArrayList<String>
            email, String status, int emailCount, String address, String
            city, String state, String zipcode, int employee, String phone, int
            myEventVisit, int mySiteVisit) {
