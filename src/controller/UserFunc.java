...
public class UserFunc {
     ...
     */
    @FXML
    public void btnActionUserTakeTransit(ActionEvent event) {
        try {
     ...
     */
    @FXML
    public void btnActionUserViewHistory(ActionEvent event) {
        try {
            Stage primaryStage = (Stage) ((Node) event.getSource()).getScene()
                    .getWindow();
            Parent root = FXMLLoader.load(getClass()
     ...
     */
    @FXML
    public void btnActionUserFuncBack(ActionEvent event) {
        try {
            Stage primaryStage = (Stage) ((Node) event.getSource()).getScene()
                    .getWindow();
            Parent root = FXMLLoader.load(getClass()
