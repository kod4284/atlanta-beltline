...
public class AdminVisitorFunc {
    @FXML
    public void btnActionAdminVisitorFuncManageProfile(ActionEvent event) {
        try {
    ...
    @FXML
    public void btnActionAdminFuncVisitorManageTransit(ActionEvent event) {
        try {
            Stage primaryStage = (Stage) ((Node) event.getSource()).getScene()
                    .getWindow();
            Parent root = FXMLLoader.load(getClass()
    ...
    @FXML
    public void btnActionAdminVisitorFuncManageSite(ActionEvent event) {
        try {
            Stage primaryStage = (Stage) ((Node) event.getSource()).getScene()
                    .getWindow();
            Parent root = FXMLLoader.load(getClass()
    ...
    @FXML
    public void btnActionAdminVisitorFuncExploreEvent(ActionEvent event) {
        try {
            Stage primaryStage = (Stage) ((Node) event.getSource()).getScene()
                    .getWindow();
            Parent root = FXMLLoader.load(getClass()
    ...
    @FXML
    public void btnActionAdminVisitorFuncViewTransitHistory(ActionEvent event) {
        try {
            Stage primaryStage = (Stage) ((Node) event.getSource()).getScene()
                    .getWindow();
            Parent root = FXMLLoader.load(getClass()
    ...
    @FXML
    public void btnActionAdminVisitorFuncManageUser(ActionEvent event) {
        try {
            Stage primaryStage = (Stage) ((Node) event.getSource()).getScene()
                    .getWindow();
            Parent root = FXMLLoader.load(getClass()
